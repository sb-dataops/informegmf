    ...
    if (action === "search") {
      ...
      const retirosSQL = `
        SELECT codigo, fecha, subasta, estado, lote, descripcion, placa, transito,
               ...
               CAST(documentosConTramitador AS STRING) AS documentosConTramitador, fechaAprobacionTramite, fechaEntregaVehiculo,
      ...
      if (category === "pendientes_traspaso") {
        sql = `
          ...
          SELECT r.subasta, r.placa, r.comprador, r.documento, r.descripcion, r.estado, r.fechaAprobacionTramite, r.lote, r.tramitador,
                 CAST(r.documentosConTramitador AS STRING) AS documentosConTramitador, t.fechaPazSalvo,
